    ...
    if blueprint_instance_names_for_scene:
        for blueprint_name in blueprint_instance_names_for_scene:
            ...
            if blueprint is not None: 
                ...
                if blueprint.local:
                    blueprint_exported_path = sanitize_os_path(os.path.join(relative_blueprints_path, f"{blueprint.name}{export_gltf_extension}"))
                else:
...
def get_blueprint_assets_tree(blueprint, blueprints_data, parent, settings):
    ...
    for material_name in blueprint_materials_names:
        ...
        materials_exported_path = os.path.join(materials_path, f"{material_name}{export_gltf_extension}")
